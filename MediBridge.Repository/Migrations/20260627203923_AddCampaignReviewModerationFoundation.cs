...
{
    /// <inheritdoc />
    public partial class AddCampaignReviewModerationFoundation : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.Sql(
                ...
                SET [PriorStatus] = 2,
                    [ResultingStatus] = CASE [Decision]
                        WHEN 1 THEN 3
                        WHEN 2 THEN 4
                        -- The legacy workflow returned change requests to Draft.
                        -- Preserve that historical fact unless the row represents
                        -- the campaign's current, still-actionable review outcome.
                        WHEN 3 THEN 1
                        ELSE 2
                    END;
