...
namespace MediBridge.Repository.Migrations
{
    ...
    [Migration("20260712231400_AddCompanyReportingAnalyticsIndexes")]
    partial class AddCompanyReportingAnalyticsIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MediBridge.Core.Entities.Messaging.DoctorAdDelivery", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "CampaignId", "FeedbackCreatedAtUtc", "Id");

                    b.HasIndex("CompanyId", "CampaignId", "InteractedAtUtc", "Status");
                    ...
                    b.HasIndex("CompanyId", "CampaignId", "DeliveryDateEgypt", "Status", "DeliveredAtUtc", "Id");
