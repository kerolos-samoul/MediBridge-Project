...
public sealed class DoctorMessageReadTrackingServiceTests
{
    ...
    private sealed class FakeDeliveryRepository : IDeliveryRepository
    {
        ...
        public Task<IReadOnlyList<CompanyReportingDeliveryAggregateReadModel>> ListCompanyCampaignDeliveryAggregatesAsync(string companyId, IReadOnlyCollection<string> campaignIds, CompanyReportingDateRange dateRange, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<CompanyReportingPageReadModel<CampaignDeliveryReportRowReadModel>> ListCompanyCampaignDeliveryReportsAsync(string companyId, string campaignId, CompanyReportingDateRange dateRange, CompanyReportingDeliveryFilters filters, CompanyReportingPagination pagination, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<CompanyReportingPageReadModel<CampaignFeedbackReportRowReadModel>> ListCompanyCampaignFeedbackReportsAsync(string companyId, string campaignId, CompanyReportingDateRange dateRange, CompanyReportingFeedbackFilters filters, CompanyReportingPagination pagination, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<IReadOnlyList<CompanyReportingDeliverySourceReadModel>> ListCompanyCampaignAnalyticsDeliveriesAsync(string companyId, string campaignId, CompanyReportingDateRange dateRange, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<IReadOnlyList<string>> ListCompanyCampaignDeliveryIdsAsync(string companyId, string campaignId, CompanyReportingDateRange dateRange, CancellationToken cancellationToken = default) => throw new NotSupportedException();
    }
