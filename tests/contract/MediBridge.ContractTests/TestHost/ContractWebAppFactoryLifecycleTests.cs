...
public sealed class ContractWebAppFactoryLifecycleTests
{
    [Fact]
    public async Task DisposeAsync_DropsGeneratedDatabase()
    {
        var factory = new ContractWebAppFactory();
    ...
    private static string GetDatabaseName(ContractWebAppFactory factory)
    {
