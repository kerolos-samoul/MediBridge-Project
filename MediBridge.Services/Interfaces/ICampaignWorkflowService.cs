...
public interface ICampaignWorkflowService
{
    ...
    Task<CampaignDto> UpdateCampaignAsync(string companyUserId, string campaignId, UpdateCampaignRequestDto request, CancellationToken cancellationToken = default);
    ...
    Task<CompanyReviewOutcomeDto> GetReviewOutcomeAsync(string companyUserId, string campaignId, CancellationToken cancellationToken = default);
