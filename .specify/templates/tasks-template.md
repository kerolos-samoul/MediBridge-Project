...
- [ ] T024 [US1] Ensure controller remains HTTP-only and delegates business logic
- [ ] T025 [US1] Ensure response envelope and exception middleware integration
...
- [ ] T032 [US2] Verify JWT + role enforcement on secured route(s)
...
- [ ] T038 [US3] Validate queue/wallet ambiguity is resolved before implementation
...
- [ ] TXXX Constitution compliance pass across all changed files
